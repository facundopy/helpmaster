<div class="employees index">
	...
	<tr<?php echo $class;?>>
		...
		<td><?php echo $employee['Employee']['nombre']; ?>&nbsp;</td>
		<td><?php echo $employee['Employee']['apellido']; ?>&nbsp;</td>
		<td><?php echo $employee['Employee']['telefono']; ?>&nbsp;</td>
		<td class="actions">
			...
			<?php echo $this->Html->link(__('Delete', true), array('action' => 'delete', $employee['Employee']['id']), null, sprintf(__('Esta seguro de eliminar este registro # %s?', true), $employee['Employee']['id'])); ?>
		</td>
	</tr>
<?php endforeach; ?>
	</table>
